...
The function is now ready for use. We use the function by calling it like any other - run the code to see the result:
...
grade_this( 
  {
    ...
    if (!is.numeric(.result)) {
      fail("Make sure you call your function on the last line of your code, and 
           that it returns a numerical value")
    }

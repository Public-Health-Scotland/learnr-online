...
The result of `chi_check()` is a character string. Depending on the validity of the CHI number, it will return one of the follow:
...
chi_numbers <- c("0101011237", "3213201234", "123456789", "12345678900", "010120123?")

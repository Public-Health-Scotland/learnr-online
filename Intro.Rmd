...
```{r borders-data, eval=TRUE, include=FALSE}
# borders <- readRDS("www/data/borders.rds")
```
...
1. Filter the data-set to show only records from `HospitalCode` "B109H"
2. Create a histogram for patient's `LengthOfStay`

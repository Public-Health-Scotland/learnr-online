...
<div>
```{r echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("images/illustrations/r_group_by.png")
```
</div>
...
Visualisations are incredibly valuable. We primarily use the `ggplot2` package but also `plotly` as you start including interactivity. Both of these packages are built on the same underlying grammar of graphics, giving us a clear structure on how to construct meaningful visualisations of our data.

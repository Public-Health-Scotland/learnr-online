...
```{sql update-table, connection="conn", exercise=TRUE, exercise.setup='insert-into-solution'}
...
```{sql delete-from, connection="conn", exercise=TRUE, exercise.setup='update-table-solution'}
...
```{sql drop-table, connection="conn", exercise=TRUE, exercise.setup='delete-from-solution'}

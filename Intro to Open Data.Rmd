...
* __automation__ - data extraction and subsquent manipulation can be easily automated when done via API
...
* Javascript
* SQL
* [Postman](https://www.postman.com/) or similar (an application specifically for building API calls)

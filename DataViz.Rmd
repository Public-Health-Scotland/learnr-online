...
borders_data_plot %>%
  filter(Specialty %in% c("AM", "AF")) %>%
  ggplot(aes(x = ageonadmission, y = LengthOfStay))
```
...
borders_data_plot %>%
  ...
  ggplot(aes(x = ageonadmission, y = LengthOfStay, colour = Specialty)) +
  geom_point(position = position_jitter()) +
  scale_colour_discrete(labels = c("___", "___"))
```
...
sp_child_immunisations_data %>%
  ggplot(aes(x = year, y = measure, colour = immunisation)) +
  geom_line() +
  scale_y_continuous(___, limits = ___) +
```
...
sp_child_immunisations_data %>%
  ...
  geom_line() +
  scale_y_continuous(name = "Uptake (%)", limits = c(0, 100)) +
  scale_x_continuous(___, ___ = ___)
```
...
sp_child_immunisations_data %>%
  ...
  scale_colour_discrete(name = "Immunisation") +
  ggtitle("Childhood Immunisation Uptake in Scotland") +
  theme(plot.title = element_text(___ = ___, ___ = ___))
```
...
sp_child_immunisations_data %>%
  ...
  scale_y_continuous(name = "Uptake (%)", limits = c(0, 100)) +
  scale_x_continuous(name = "Year", n.breaks = 7) + 
  scale_colour_discrete(name = "Immunisation", ___ = c(___, ___)) +
  ggtitle("Childhood Immunisation Uptake in Scotland") +
  theme(plot.title = element_text(colour = "#3A3776", face = "bold"))
```
...
sp_child_immunisations_data %>%
  ...
  theme(plot.title = element_text(colour = "#3A3776", face = "bold"),
        panel.background = element_blank(),
        panel.grid.major = element_line(___),
        panel.grid.minor = element_line(___))
```
...
immunisation_uptake_plot + phs_theme_line
```

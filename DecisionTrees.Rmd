...
We can read in our Titanic data using `read_csv()` from the `{readr}` package. Try clicking "Run Code" to do so:
...
(Note: you won't be able to access this data from your own RStudio session so we recommend following along via the interactive coding sections in the course.)

...
```
This shows us that 40.9% of passengers in the training data survived and 59.1% did not.
...
titanic_test %>%
 janitor::tabyl(survived_flag)
```
And this shows us that 38.7% of passengers in the testing data survived and 61.3% did not.

...
a) the outcome variable of interest, the `survived` flag
...
titanic_test_pred <- titanic_test %>%
  add_predictions(titanic_fit, type = "class", var = "survival_pred")

titanic_test_pred
```

You can see that we have the original `survival_flag` column and now, next to it, the new `survival_pred` column. Comparing the two gives us an idea of how effective our decision tree is at predicting.

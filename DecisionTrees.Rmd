...
The useful part of a decision tree is that the predicted outcome variable can be continuous:
...
a) the outcome variable of interest, named `survived_flag` in the answer above (take note of how the 'positive' answer `"Yes"` is placed first in the `levels` ordering - this is important for assessing our model later)

b) a collection of potential predictors that may be useful in our model when predicting `survived`
...
## Decision trees with a continuous outcome variable

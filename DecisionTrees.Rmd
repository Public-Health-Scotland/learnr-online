...
6.	Interpret the model, i.e. which variables in the data help predict survival? Which passenger demographics fare best?

7.	Test the model’s predictive power by comparing predicted values to those in our data (via a **confusion matrix**, examining **sensitivity** and **specificity**)

Following this, we will create a **random forest** model and see if this improves the predictive power we can attain.
...
```{r echo=FALSE, fig.align='center', out.width="75%", fig.alt = "The root node of the newly-created decision tree."}

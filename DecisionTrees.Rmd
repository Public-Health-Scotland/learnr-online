...
Use `ggplot()` to create some visualisations to see which variables appear to have the greatest effect on survival.
...
grade_this({
  ...
  fail_if(
    !all.equal(.result$call$data, titanic_train),

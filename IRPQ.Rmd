...
9. Complete the sign-off procedure. (see section [PQ - Sign Offza](https://scotland.shinyapps.io/phs-learn-irpq/#section-pq---sign-off))  
...
```{r echo=FALSE, fig.align='center', out.width="100%", fig.alt="Example of a PQ Draft Answer"}
knitr::include_graphics("images/irpq/irpq-PQExample.png")
```
...
<div class="info_box">
  ...
  * Please remember to use the template located in Appendix 3 of the [Parliamentary Questions Protocol Guide](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/parliamentary-questions/) when Drafting PQ Answers.
...
| Role                                  |    First sign off    |    Final sign off    |
|:--------------------------------------|:---------------------|:---------------------|
| Associate Directors                   |         ✓            |         ✓            |
| Head of Service                       |         ✓            |         ✓            |
| Consultants in Public Health Medicine |         ✓            |         ✓            |
| Service Managers - can approve questions in own area only |         ✓            |                      |
| Chief Pharmacist                      |         ✓            |         ✓            |
| Director                              |                      |         ✓            |
| Medical director                      |                      |         ✓            |
...
```{r echo=FALSE, fig.align='center', out.width="50%", fig.alt="Flow chart of sign off procedure"}
knitr::include_graphics("images/irpq/irpq-signOffProcess.png")
```
...
<div class="info_box">
  ...
  * First and final sign offs must be undertaken by different people.
  
  * Service Managers can only approve responses from their own area.
  
  * If further work is advised, this must be clearly explained and agreed with the service area.
  
  * Teams should ensure records of the PQ sign-offs are retained for proper record-keeping - this could be storing the email chain with the sign-off request and approval in a designated Sharepoint team folder, for example.
...
<div class="info_box">
  ...
  * A copy of your draft answer will be submitted to the relevant NHS boards using the standard template found within [Appendix 2 of the IR Protocol](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/information-requests/)</a>.
...
You have reached the end of the Parliamentary Question and Information Request course. Take a moment and reflect on your learning using the following learning outcomes checklist.  

Remember, if you have any gaps in your knowledge, you can always navigate back to the appropriate sections using the navigation banner on the left hand side:
...
<div class="info_box">
  ...
  1. **Information Requests**
        ...
        <input type="checkbox" unchecked> What is an IR? </input>  
        
        <input type="checkbox" unchecked> How long do I have to respond to an IR? </input>  
        
        <input type="checkbox" unchecked> How do I work with my team to deal with an IR? </input>  
        
        <input type="checkbox" unchecked> How do I log, retrieve and answer an IR? </input>  
        
        <input type="checkbox" unchecked> What factors should I consider when answering an IR? </input>  
        
        <input type="checkbox" unchecked> How do I close an IR? </input>  
        

  2. **Parliamentary Questions**
        
        <input type="checkbox" unchecked> What is a PQ? </input>  
        
        <input type="checkbox" unchecked> How are PQs created, retrieved and allocated to PHS teams? </input>  
        
        <input type="checkbox" unchecked> What do I do if a PQ has been allocated to my team? </input>  
        
        <input type="checkbox" unchecked> What considerations should I bear in mind when answering a PQ? </input>  
        
        <input type="checkbox" unchecked> How do I answer a PQ? </input>  
        
        <input type="checkbox" unchecked> How do I sign off a PQ answer? </input>  
        
        <input type="checkbox" unchecked> How do I submit a PQ answer? </input>  
...
The following is a list of useful documents and their location:

* [FOI/EIR Protocol](https://spark.publichealthscotland.org/corporate-guidance/information-governance/data-protection/data-protection-handbook/freedom-of-information-foi/)    

* [Information Request Protocol](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/information-requests/)  

* [Information Request Form](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/information-requests/)  

* [Parliamentary Questions Protocol](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/parliamentary-questions/)  

* [SDC Protocol / Risk Assessment Form / SDC Flowchart](https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/statistical-disclosure-control/overview-of-disclosure-control-protocol/)  
...
<iframe width="640px" height="480px" src="https://forms.office.com/Pages/ResponsePage.aspx?id=veDvEDCgykuAnLXmdF5Jmr0sIZ-lbnFLgOZzAjI8c8BUMDU5WU5YOTYwRkVZQzMxWDNVTERTRTZVWSQlQCN0PWcu" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe>

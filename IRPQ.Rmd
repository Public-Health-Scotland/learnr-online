...
<div class="info_box">
  <h4>Course Info</h4>
  <ul>
    <li>This course is separated into two main sections: **Parliamentary Questions** and **Information Requests**</li>
    ...
    <li>If you are comfortable with the content and are looking for specific information or guidance, feel free to navigate through to the appropriate section located in the navigation banner.</li>
...
<ol>
  ...
  <li>If correctly assigned and the team are able to answer, contact SG to enquire whether a response is required (see section *PQ - Processing & Responding*)</li>
  </br>
...
* If your team is unable to answer the question, why is that? Did you incorrectly receive the PQ, and that error needs to be fed back to the StatsGov team?
...
<input type="checkbox" unchecked> Be brief, while supplying enough information. </input> 
</br>
</br>
<input type="checkbox" unchecked> Have a purpose to every phrase. </input>
</br>
</br>
<input type="checkbox" unchecked> Provide data to answer the question, or explain why you cannot. </input>
</br>
</br>
...
<input type="checkbox" unchecked> Data must be understandable and fit for purpose. </input> 
</br>
</br>
<input type="checkbox" unchecked> Explain why a question cannot be answered - e.g. *This dataset is not held by PHS* </input>
</br>
</br>
<input type="checkbox" unchecked> Data not fit to be used in the draft answer is not to be used as a Background Note. </input>
</br>
</br>
...
<input type="checkbox" unchecked> Do not offer very limited insight. </input> 
</br>
</br>
<input type="checkbox" unchecked> If necessary, seek specialist advice (e.g. CPHM, Clinical Coders, Nurse, Pharmacist) before proceeding to answer the question. </input>
</br>
</br>
...
<input type="checkbox" unchecked> Plain English </input> 
</br>
</br>
<input type="checkbox" unchecked> Non technical</input>
</br>
</br>
<input type="checkbox" unchecked> Tables should be clearly and fully labelled </input> 
</br>
</br>
<input type="checkbox" unchecked> Acronyms explained</input>
</br>
</br>
<input type="checkbox" unchecked> **No first release of stats if there is a plan to release in the next 12 weeks** </input> 
</br>
</br>
...
<div class="info_box">
  ...
  <li>For particularly hot topics, PHS staff should specifically request they be consulted of any proposed changes to the content or wording of the PQ by the SG.
...
quiz(
  question("You have received a PQ which you have been asked to respond to by the SG. The data you have access to is not clear, and as such, you cannot fully answer the question. What do you do?",
           answer("Do not offer the limited insight.", correct = TRUE),
           ...
           answer("Send the SG the data, and explain why you cannot answer it.", correct = FALSE),
           answer("Contact specialists on the data to gain clarity, to assist in answering.", correct = TRUE),
           answer("Do nothing. You cannot answer the question so it is better not to confuse anyone.", correct = FALSE),
           incorrect = "Not quite, have another go!",
           allow_retry = TRUE,
           random_answer_order = TRUE
           ),
  question("Your response to a question will include data that is contained in a publication due to be released in 10 weeks. You should release the answer with the data since PQs are important, and should be answered as soon as possible.",
           answer("TRUE"),
           answer("FALSE", correct = TRUE),
           incorrect = "Not quite, have another go!",
           allow_retry = TRUE,
...
* **Incorrectly assigned** - Forward the question to the appropriate team, copying Stats Gov for future reference. If there are no appropriate teams, contact Stats Gov and make them aware. No further action is required.
...
quiz(
  ...
  question("If I receive a PQ under the action 'For Information', I should not take any action.",
           answer("TRUE", correct = FALSE),
           answer("FALSE", correct = TRUE),
           incorrect = "Not quite, have another go!",
...
In the previous sections of this course you covered what PQs are. In a broader sense, PQs are a type of Information Request from MSP's.
...
<ol>
  ...
  <li>Team sends the **Information Request Form** (see section *Useful Documents*) to the customer and awaits for the information to be returned.
  </br>
  ...
  <li>Have the analysis checked by an appropriate member of the team (e.g. Principal Analyst or Service Manager).</li>
  </br>
  <li>If this is the first time the information is being released, it should be sent to preview 48 hours before it is released to the customer as follow: 
    <ul>
      <li> Analysis relating to specific Health Board: Email PHS preview mailbox. Request that the IR is sent to the Chief Executive and Communications Manager at that specific board.
      <li> Analysis at national level: Email the IR to your policy contact at the Scottish Government. 
      </li>
  </br>
</ol>
...
As already discussed, all IRs should be logged into the Information Request Service.

Below is a step by step tutorial of how to log and close IRs into the system.
...
2) **Summary** - Select *Information Request (Non ISD)* as the Request Type, and fill in relevant information as shown below. *Note: The default deadline is 20 working days from when IR is received. This should be updated after discussion with the customer.* 
...
If a customer is to be charged, a fees notice and explanation of the fees must be sent whent the specification of the IR is being discussed. 
...
<div class="info_box">
  <h4>Important</h4>
  <ul>
  <li> Do not charge for IRs where the analytical work is already available.
...
As stated in *IR - Workflow*, once you have logged the IR within the IRS, you should then assess the request with your team.

Each team will have their own local methods to assess the request. 

Below are some general principles and considerations which should be discussed with your team, and understood before proceeding to contact the customer.

### General Principles

* Is the request clear, or do you need further clarification from the customer?

* Do you have the resources available to respond to the IR?

* Does responding to the IR impact on any Statistical Governance or Data Protection principles which the PHS adheres to?

* Can the IR be responded to within 20 working days from when the specification is agreed with the customer?

* Is this a repeat or similar request?

...
<ol>
  ...
  <li>IR is logged in the IRS (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-ir---form-service" target="_blank">*IR - Form & Service*</a>) and given a reference number.</li>
  </br>
  <li>IR is assessed by the team (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-ir---assessing-the-request" target="_blank">*IR - Assessing the Request*</a>)</li>
  </br>
  <li>If the request has not been made via the **Information Request Form** (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-ir---form-service" target="_blank">*IR - Form & Service*</a>), teams are encouraged to send this form to the customer and request it be filled out and returned. Proceed to the next stage once it has been returned.
  </br>
  </br>
...
A screen grab of the form can be seen below. The attachable document file (with working hyperlinks) can be found in the <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-useful-documentation-links" target="_blank">*Useful Documentation & Links*</a> section of this course, as well as on <a href="https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/information-requests/" target="_blank">Spark</a>.
...
<ol>
  ...
  <li>The PHS Statistical Governance Team (phs.statsgov@phs.scot) retrieves and assigns the PQs to the appropriate PHS teams (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-pq---retrieving-assigning-pqs" target="_blank">*PQ - Retrieving & Assigning PQs*</a>).</li>
  </br>
  <li>Teams receive and assess the PQ. </li>
  </br>
  <li>If correctly assigned and the team are able to answer, contact SG to enquire whether a response is required (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-pq---processing-responding" target="_blank">*PQ - Processing & Responding*</a> for further information on the process at this stage, including for instances where PQs have been incorrectly assigned, or unable to be answered).</li>
  </br>
  <li>If a response is required, log the PQ in the IRS. (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-ir---form-service" target="_blank">*IR - Form & Service*</a>)</li>
  </br>
  ...
  <li>Produce draft answer in accordance with style guidelines, using the appropriate template. (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-pq---processing-responding" target="_blank">*PQ - Processing & Responding*</a>)</li>
  </br>
  <li>Complete the sign-off procedure. (see section <a href="https://scotland.shinyapps.io/phs-learn-irpq/#section-pq---sign-off" target="_blank">*PQ - Sign Off*</a>)</li>
  </br>
...
<div class="info_box">
  <h4>Important</h4>
  <ul>
    <li>PHS Teams may, at times, receive PQs directly from Scottish Government contacts. In this instance, teams should carry out the PQ process above as normal proceeding from the **Teams receive and assess the PQ** of the above list.
  </ul>
</div>
</br>
...
Further examples can be found in Appendix 4 of the <a href="https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/parliamentary-questions/" target="_blank">Parliamentary Questions Protocol.</a>
...
| <span class="center-align"><a href="https://spark.publichealthscotland.org/corporate-guidance/statistical-governance/information-requests/" target="_blank">Information Request Form</a></span> 

...
<input type="checkbox" unchecked> Be brief, but with enough information. </input> 
</br>
</br>
<input type="checkbox" unchecked> Have a purpose with every phrase. </input>
</br>
</br>
...
<input type="checkbox" unchecked> Data not fit to be used in the draft answer is not used as a Background Note. </input>
</br>
</br>
...
<input type="checkbox" unchecked> Explain issues with data used within teh Draft Answer</input>
</br>
</br>

...
quiz(
  question("Which of the following PQ's have Stats Gov reviewed? Please select all that apply. 'To ask the Scottish Government...",
...
quiz(
  question("You have received a PQ which is not related to your service area, and has only been sent to your team. What should you do?",
           ...
           incorrect = "You should make sure the PQ reaches the appropriate team, and ensure the allocation error does not. (There are 2 correct options)",
           allow_retry = TRUE,
           random_answer_order = TRUE
           ),
  question("If you receive a PQ with Action 'For Information', you do not need to take any further action other than reading the PQ",
           ...
           incorrect = "Teams should still read the PQs and take further action if necessary.",
           allow_retry = TRUE,
           random_answer_order = TRUE
           )
)
...
quiz(
  question("To ask the Scottish Government how many (A) adults and (B) children have been registered with a dentist in each year since 2005.",
           ...
           incorrect = "There is no need to know the reason for visiting the dentist. Try again.",
           allow_retry = TRUE,
           random_answer_order = TRUE
           ),
  question("To ask the Scottish Government how many people have been prescribed drugs for depression in each year since 2005, broken down into (A) children, (B) adolescents, (C) adults and (D) elderly people in each NHS board area.",
           ...
           incorrect = "There is no need to know how long an individual has been prescribed drugs. Try again.",
           allow_retry = TRUE,
           random_answer_order = TRUE
           )
)
...
quiz(
  question("You have received a PQ which you have been asked to respond to by the SG. The data you have access to is not clear, and as such, you cannot fully answer the question. What do you do?",
           ...
           incorrect = "You should not be sending unclear data to SG. You should still provide an explanation to the SG. (there are 3 correct answers)",
           allow_retry = TRUE,
           random_answer_order = TRUE
           ),
...
In the previous sections of this course you covered what PQs are. 

In a broader sense, PQs are a type of Information Request from MSPs.
...
While teams may have their own local procedures in dealing with Information Requests, it is encouraged to have customers fill in and return an *Information Request Form* in the first instance. We have provided an example form for teams to adapt for their purposes.
...
<div class="info_box">
  <h4>Important</h4>
  <ul>
    <li>The 20 day deadline to fulfil the IR will begin from when the specification has been agreed with the customer, following the team's assessment of the IR Form.
  </ul>
</div>
</br>
...
As already discussed, all IRs should be logged in the Information Request Service.
...
Following this discussion, the teams outputted the following spreadsheet to the customer via email:

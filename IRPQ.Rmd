...
Below is a checklist of said principles which users can work through.
...
<input type="checkbox" unchecked> State why question is answered in a certain way </input> 
</br>
</br>
<input type="checkbox" unchecked> Explain issues with data used within the Draft Answer</input>
</br>
</br>
<input type="checkbox" unchecked> Sources and other useful briefings </input> 

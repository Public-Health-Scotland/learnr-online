...
<div class="info_box">
  ...
  <ul>
    ...
    <li>If you wish to reset all the quizzes and start over from the beginning, locate and press the '*Start Over*' button beneath the navigation banner on the left hand side.
    </br>
  </ul>
</div>
...
quiz(
  question("Which of the following PQ's have Stats Gov reviewed? Please select all that apply. 'To ask the Scottish Government... (select ALL that apply)",

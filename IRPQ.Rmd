...
<ol>
  ...
  <li>Team sends the **Information Request Form** (see section *IR - Information Request Form*) to the customer and await for the information to be returned.
  </br>
...
A screen grab of the form can be seen below. The attachable document file (with working hyperlinks) can be found in the *Useful Documents* section of this course.

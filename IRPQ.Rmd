...
<div class="info_box">
  <h4>Important</h4>
  <ul>
  <li>Stats Gov are not specialists within the individual topic areas, and may occasionally assign a PQ's Topic Area or Action in error. Teams are expected to read through all PQs assigned to them and, where possible, communicate with appropriate teams and personnel in order to provide SG with as much assistance as possible.
